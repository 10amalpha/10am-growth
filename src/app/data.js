...
export const STRATEGY_PATHS = [
  ...
  { id:"calendar", title:"Revenue Event Calendar", description:"4 events active on Luma. Ep200 Fireside (163 reg, $40) + Alpha AMAs (100+ reg, $15) + private almuerzos. AMAs reduce churn.", current:4, target:12, unit:"events/yr", color:"#EF4444", revImpact:"$2-5K per event", actions:["Execute Ep200 event (May)","Monthly Alpha AMA cadence ($15)","Quarterly private almuerzo (retention)","Track ticket rev vs churn reduction"] },
];
