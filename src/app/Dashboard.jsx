          ...
          <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr",gap:16,marginBottom:16}}>
            ...
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.04)",borderRadius:12,padding:"20px"}}>
              ...
              <div style={{marginTop:12,padding:"10px 12px",background:"rgba(34,197,94,0.04)",border:"1px solid rgba(34,197,94,0.1)",borderRadius:8}}>
                <div style={{fontSize:10,color:"#22C55E",fontWeight:600,marginBottom:2}}>Monthly churn: ~15% on $40/mo subs — AMAs may be bending the curve</div>
                <div style={{fontSize:10,color:"#71717A",lineHeight:1.5}}>Jan M2: 83% → Feb M2: 88% (+5pp). AMAs started March — if Mar M2 hits 90%+ in May, the thesis is confirmed. Each 5pp retention improvement = ~$400/mo saved. Track this monthly.</div>
              </div>
            </div>
          </div>
          {/* Risk flags */}
          ...
          <div style={{background:"rgba(212,168,67,0.03)",border:"1px solid rgba(212,168,67,0.1)",borderRadius:12,padding:"20px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr",gap:10,marginBottom:20}}>
              {[
                ...
                {signal:"Retention improving: Jan 83% → Feb 88% at M2",detail:"Monthly $40 sub retention gained 5pp between Jan and Feb cohorts. AMAs started in March — if Mar cohort hits 90% at M2 (check in May), the AMA thesis is proven. Each 5pp = ~$400/mo saved MRR. 32% of MRR is locked in annual plans — focus churn efforts on the 68% monthly base.",color:"#22C55E",action:"Check Mar M2 retention in May"},
