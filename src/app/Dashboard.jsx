...
const EfMetric=({label,value,sub,accent="#22C55E",mob})=>(<div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:8,padding:mob?"10px 8px":"12px",textAlign:"center",minWidth:0}}><div style={{fontSize:mob?7:8,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:3}}>{label}</div><div style={{fontSize:mob?15:18,fontWeight:700,color:accent,fontFamily:"'Space Grotesk'"}}>{value}</div>{sub&&<div style={{fontSize:mob?8:9,color:"#52525B",marginTop:2}}>{sub}</div>}</div>);
      ...
      <div style={{background:"linear-gradient(180deg,rgba(12,14,20,1) 0%,#08090D 100%)",borderBottom:"1px solid rgba(255,255,255,0.04)",padding:"14px 24px"}}>
        <div style={{maxWidth:1280,margin:"0 auto",display:"flex",alignItems:mob?"flex-start":"center",justifyContent:"space-between",flexDirection:mob?"column":"row",gap:mob?12:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:12}}>
            ...
            <a href="https://10am.pro" target="_blank" rel="noopener noreferrer" style={{fontSize:10,color:"#3F3F46",textDecoration:"none",borderBottom:"1px dotted #27272A"}}>10am.pro</a>
      ...
      <div style={{maxWidth:1280,margin:"0 auto",padding:"20px 24px 40px"}}>
        ...
        {view==="emailfirst"&&(<div>
            ...
            <div style={{background:"linear-gradient(135deg,rgba(34,197,94,0.04),rgba(212,168,67,0.03))",border:"1px solid rgba(34,197,94,0.1)",borderRadius:12,padding:mob?"12px 14px":"16px 24px",marginBottom:16,display:"flex",flexDirection:mob?"column":"row",alignItems:mob?"flex-start":"center",justifyContent:"space-between",gap:mob?8:12}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:mob?8:16,fontSize:mob?9:10,flexWrap:"wrap"}}>
                <span style={{color:"#52525B"}}>Rev: <span style={{color:"#22C55E",fontWeight:700}}>{fmt(latestPnl.totalRev)}</span></span>
                <span style={{color:"#3F3F46"}}>→</span>
                <span style={{color:"#52525B"}}>Meta: <span style={{color:"#D4A843",fontWeight:700}}>$41.7K</span></span>
            ...
            {efSection==="overview"&&(<div>
              ...
              <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:mob?"14px":"20px 24px",marginBottom:16}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:mob?10:20,marginBottom:14,flexWrap:"wrap",justifyContent:mob?"center":"flex-start"}}>
                  <div style={{textAlign:"center"}}><div style={{fontSize:9,color:"#52525B",marginBottom:2}}>Actual</div><div style={{fontSize:mob?20:26,fontWeight:800,color:"#22C55E",fontFamily:"'Space Grotesk'"}}>{latestPnl.totalRev?latestPnl.totalRev.toLocaleString("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}):"—"}</div><div style={{fontSize:9,color:"#3F3F46"}}>/mes</div></div>
                  <span style={{fontSize:20,color:"#27272A"}}>→</span>
                  <div style={{textAlign:"center"}}><div style={{fontSize:9,color:"#52525B",marginBottom:2}}>Meta</div><div style={{fontSize:mob?20:26,fontWeight:800,color:"#D4A843",fontFamily:"'Space Grotesk'"}}>$41,667</div><div style={{fontSize:9,color:"#3F3F46"}}>/mes ($500K ARR)</div></div>
                  <span style={{fontSize:20,color:"#27272A"}}>=</span>
                  <div style={{textAlign:"center"}}><div style={{fontSize:9,color:"#52525B",marginBottom:2}}>Gap</div><div style={{fontSize:mob?20:26,fontWeight:800,color:"#EF4444",fontFamily:"'Space Grotesk'"}}>{fmt(monthlyGap)}</div><div style={{fontSize:9,color:"#3F3F46"}}>/mes faltante</div></div>
                </div>
              ...
              <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr",gap:12,marginBottom:16}}>
                <div style={{background:"rgba(129,140,248,0.03)",border:"1px solid rgba(129,140,248,0.1)",borderRadius:10,padding:mob?"14px":"18px 20px"}}>
                  ...
                  <div style={{fontSize:9,color:"#52525B"}}>{pnlComputed[0]?.stripe>0?"+"+((latestPnl.stripe-pnlComputed[0].stripe)/pnlComputed[0].stripe*100).toFixed(0)+"% YoY":"—"}</div>
                  <div style={{fontSize:9,color:"#52525B",marginTop:2}}>Core revenue engine · Compounding</div>
                </div>
                <div style={{background:"rgba(239,68,68,0.03)",border:"1px solid rgba(239,68,68,0.1)",borderRadius:10,padding:mob?"14px":"18px 20px"}}>
                  ...
                  <div style={{fontSize:9,color:"#52525B"}}>Plateauing</div>
            ...
            {efSection==="decision"&&(<div>
              ...
              <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(212,168,67,0.15)",borderRadius:12,padding:mob?"14px":"20px 24px"}}>
                <div style={{fontSize:9,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:14}}>Revenue por Follower: Revenue por Follower</div>
            ...
            {efSection==="comparison"&&(<div>
              <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:mob?"14px":"20px 24px",marginBottom:16}}>
                <div style={{fontSize:9,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:14}}>⚖️ Email vs Optimizar Conversión</div>
              ...
              <div style={{background:"rgba(212,168,67,0.03)",border:"1px solid rgba(212,168,67,0.12)",borderRadius:12,padding:mob?"14px":"20px 24px",textAlign:"center"}}>
                ...
                <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:mob?12:20,flexWrap:"wrap"}}>
                  <div><div style={{fontSize:mob?30:38,fontWeight:800,color:"#22C55E",fontFamily:"'Space Grotesk'"}}>8.6×</div><div style={{fontSize:9,color:"#52525B"}}>más impacto con email acquisition</div></div>
        ...
        {view==="conversion"&&(<div>
          ...
          <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:"20px",marginBottom:16}}>
            <div style={{fontSize:10,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:16}}>Conversion Rate by Source (Visitor → Subscriber)</div>
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {[
                ...
                {source:"Direct to App",subs:158,visitors:25463,rate:0.6,color:"#52525B",rev:"$1,440"},
                ...
                <div style={{width:mob?0:70,textAlign:"right",fontSize:10,color:"#3F3F46",display:mob?"none":"block"}}>{ch.rev}</div>
              </div>))}
            </div>
            <div style={{display:"flex",gap:16,marginTop:12,fontSize:10,color:"#52525B",justifyContent:"flex-end"}}>
          ...
          <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:"20px",marginBottom:16}}>
            <div style={{fontSize:10,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:4}}>Substack Recommendations Network</div>
            <div style={{fontSize:10,color:"#52525B",marginBottom:16}}>Other Substacks recommending 10AMPRO — free subscriber acquisition</div>
            <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"repeat(3,1fr)",gap:10}}>
              {[
                ...
                {name:"Nicolás Fernández",subs:3,rev:"$0",color:"#3F3F46",badge:"co-host"},
          ...
          <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:"20px",marginBottom:16}}>
            <div style={{fontSize:10,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:4}}>Substack Notes — Top Performing</div>
            <div style={{fontSize:10,color:"#52525B",marginBottom:16}}>Notes that drove subscriber acquisition</div>
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              {[
                ...
                <div style={{width:20,textAlign:"center",fontSize:11,color:"#3F3F46",fontWeight:600}}>{i+1}</div>
                <div style={{flex:1,fontSize:11,color:"#A1A1AA"}}>{n.note}</div>
                <div style={{fontSize:10,color:"#52525B"}}>{n.author}</div>
          ...
          <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:12,padding:"20px",marginBottom:16}}>
            <div style={{fontSize:10,color:"#3F3F46",textTransform:"uppercase",letterSpacing:"0.1em",marginBottom:16}}>Monthly: New Subs + Shorts Views + Google SEO</div>
            <div style={{width:"100%",overflowX:"auto"}}>
              <ComposedChart width={mob?360:780} height={280} data={[
                ...
                <XAxis dataKey="m" tick={{fontSize:9,fill:"#3F3F46"}} tickLine={false} axisLine={{stroke:"#1A1A2E"}}/>
            ...
            <div style={{display:"flex",gap:16,marginTop:8,padding:"0 8px"}}>
              {[{c:"#FF6719",l:"New Subs (total)"},{c:"#4285F4",l:"Google SEO subs"},{c:"#E1306C",l:"Shorts Views"}].map((lg,i)=>(<div key={i} style={{display:"flex",alignItems:"center",gap:4}}><div style={{width:8,height:8,borderRadius:2,background:lg.c}}/><span style={{fontSize:10,color:"#52525B"}}>{lg.l}</span></div>))}
            </div>
          </div>
