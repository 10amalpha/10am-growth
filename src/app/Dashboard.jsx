          ...
          <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr",gap:16,marginBottom:16}}>
            ...
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.04)",borderRadius:12,padding:"20px"}}>
              ...
              <div style={{marginTop:12,padding:"10px 12px",background:"rgba(34,197,94,0.04)",border:"1px solid rgba(34,197,94,0.1)",borderRadius:8}}>
                <div style={{fontSize:10,color:"#22C55E",fontWeight:600,marginBottom:2}}>Monthly churn: ~15% on $40/mo subs — retention stack building</div>
                <div style={{fontSize:10,color:"#71717A",lineHeight:1.5}}>Jan M2: 83% → Feb M2: 88% (+5pp). Retention levers active: <span style={{color:"#D4A843",fontWeight:600}}>AMAs</span> (monthly engagement), <span style={{color:"#22C55E",fontWeight:600}}>mercados.10am.pro</span> (daily tab habit), <span style={{color:"#818CF8",fontWeight:600}}>Cerebro AI</span> (knowledge engine), <span style={{color:"#FF6719",fontWeight:600}}>el Búnker</span> (WhatsApp community). Check Mar M2 in May — if 90%+, the stack is working.</div>
              </div>
            </div>
          </div>
          {/* Risk flags */}
          <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(239,68,68,0.1)",borderRadius:12,padding:"16px 20px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:mob?"1fr":"1fr 1fr 1fr",gap:10}}>
              ...
              <div style={{padding:"10px 14px",background:"rgba(129,140,248,0.03)",borderRadius:8,border:"1px solid rgba(129,140,248,0.08)"}}>
                ...
                <div style={{fontSize:10,color:"#71717A",lineHeight:1.5}}>61% of active subs paid once. Activate them fast: welcome email → mercados.10am.pro access (code ELGORDO) → Búnker invite → next AMA invite. The retention stack must hit them in week 1.</div>
              </div>
            </div>
          </div>
        </div>)}
